...
{
    public class shhsyxwGenerator : BaseGenerator
    {
        public shhsyxwGenerator()
        {
            this.LotteryId = 4;
        ...
        {
            var startTime = new DateTime(date.Year, date.Month, date.Day, 9, 00, 0);
            var endTime = new DateTime(date.Year, date.Month, date.Day, 23, 50, 0);
