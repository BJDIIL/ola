...
{
    public class shdsyxwGenerator : BaseGenerator
    {
        public shdsyxwGenerator()
        {
            this.LotteryId = 2;
        ...
        {
            // 08：35 -- 22：55
            var startTime = new DateTime(date.Year, date.Month, date.Day, 8, 35, 0);
            var endTime = new DateTime(date.Year, date.Month, date.Day, 22, 55, 0);
