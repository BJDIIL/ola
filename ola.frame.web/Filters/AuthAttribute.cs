...
namespace ola.frame.web.Filters
{
    ...
    {
        protected static readonly ILog log = LogManager.GetLogger(typeof(AuthAttribute));
        public override void OnAuthorization(AuthorizationContext filterContext)
        {
            //return;
            try
            {
                var redirectUrl = "/Login/Index?returnUrl=" + filterContext.HttpContext.Request.Url;
